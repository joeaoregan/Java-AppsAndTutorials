...
public class ChatClient {
	...
	public ChatClient() {
		...
		textField.addActionListener(new ActionListener() {
			/**
			 * Responds to pressing the enter key by sending the contents of the text field
			 * to the server, then clear it in preparation for the next message.
			 */
	...
	private String getName() {		
		...
		frame.setTitle("Chatter: " + name);	// Set the window title to include username
		return name;
	}
